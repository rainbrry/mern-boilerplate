...
route.put("/return-selling/:id", isCashier, SellingsController.returnItem);
...
route.get("/expenses", isCashier, ExpensesController.index);
route.post("/expense", isCashier, ExpensesController.store);
route.put("/expense/:id", isCashier, ExpensesController.update);
route.delete("/expense/:id", isCashier, ExpensesController.destroy);
