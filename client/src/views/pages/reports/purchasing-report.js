...
import { useGetPurchasingReportsQuery } from "../../../services/api/reports";

export default function PurchasingReport() {
	const {
		data: purchasingReports = [],
		isLoading,
		isError,
	} = useGetPurchasingReportsQuery();

	const grandTotal = purchasingReports.reduce(
						...
						<div id="report" className="">
							<table className="table-fixed w-full border-r border-l border-t">
								...
								<tbody className="text-md divide-y text-left divide-gray-100 overflow-hidden">
									...
									) : isError || !purchasingReports.length ? (
										<tr>
											<td className="p-4 whitespace-nowrap" colSpan="5">
												<div className="text-center text-lg font-semibold mt-56">
													No data
										...
										<tr className="bg-gray-50">
											...
											>
												<div className="font-semibold">
													Total pembelian : {rupiah(grandTotal)}
												</div>
											</td>
										</tr>
									</tfoot>
